...
def din_attention(query, facts, attention_size=None, mask=None, stag='null', mode='SUM', att_func='all',softmax_stag=1, time_major=False, return_alphas=False,reuse=None,top_k=None):
